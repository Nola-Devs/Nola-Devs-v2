...
>
	...
	<Modal style="width:80%" bind:open={popupModal} size="xs" autoclose outsideclose>
		<div class="text-center" style="padding-top:20px">
		  <Button style="margin-bottom:10px" on:click={()=>downloadICS(event)}>Download Calender Event</Button>
		  <a style="padding-left:37px;padding-right:37px" class= "font-medium focus-within:ring-4 focus-within:outline-none inline-flex items-center justify-center px-5 py-2.5 text-sm text-white bg-primary-700 hover:bg-primary-800 dark:bg-primary-600 dark:hover:bg-primary-700 focus-within:ring-primary-300 dark:focus-within:ring-primary-800 rounded-lg"
		  href="{ctaLink}"
		  target="_blank"
		  rel="noopener noreferrer"
		  >
