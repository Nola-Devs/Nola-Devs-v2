<script lang="ts">
	...
	import HacknightSash from '../hacknight-sash.svelte';
</script>

<div
	class="{twMerge(
		'text-gray-900 max-h-64 md:max-h-80 bg-cover bg-no-repeat bg-white/10 p-8 rounded-lg shadow-md relative',
		bannerClass
	)}"
>
		<HacknightSash />
	<div class="max-w-[672px]">
		...
		<p class="mb-8 leading-[24px] hidden sm:block sm:text-sm md:text-base dark:text-violet-300">
			{description}
		</p>
		<a
			href="{linkHref}"
