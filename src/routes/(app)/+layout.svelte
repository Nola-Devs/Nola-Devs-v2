...
<div class="flex h-screen w-screen 3xl:mx-auto 3xl:max-w-screen-2xl overfloww-hidden">
	
	<Sidebar {data} />
	<main class="grid grid-rows-[200px_500px-auto] w-full p-4 sm:px-8 3xl:px-0 overfloww-hidden">
