...
| Tunnel URL            | `CLOUDFLARE_URL`         | Public tunnel to your dev server, ex: `https://....trycloudflare.com` | `noladevs eventbot` |
...
The Slack app that lets organizers add and cancel events from the community Slack. Setting it up
locally takes a few extra steps (Slack CLI, a tunnel, a test workspace), so it has its own guide:
[EVENTBOT.md](./EVENTBOT.md).
